...
class rest_api_lib:
    ...
    def login(self, vmanage_ip, username, password):
        ...
        policy_id = "fbeb35f6-4f1b-4fe0-ac61-3d74209a2113"
        activate_policy_url = "https://%s/dataservice/template/policy/vsmart/activate/fbeb35f6-4f1b-4fe0-ac61-3d74209a2113"%(self.vmanage_ip)
        deactivate_policy_url = "https://%s/dataservice/template/policy/vsmart/deactivate/fbeb35f6-4f1b-4fe0-ac61-3d74209a2113"%(self.vmanage_ip)
        payload = "{\n }"
